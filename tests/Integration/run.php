...
$suites = ['logger', 'handlers', 'phone', 'jalali', 'validator', 'otp', 'user', 'charge', 'costissue', 'accounting', 'roles', 'documents', 'votes', 'bulkusers', 'audit', 'security', 'messaging', 'codebase', 'e2e'];
