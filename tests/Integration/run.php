...
$suites = ['logger', 'handlers', 'phone', 'jalali', 'validator', 'otp', 'user', 'charge', 'costissue', 'accounting', 'roles', 'documents', 'votes', 'bulkusers', 'audit', 'security', 'reports', 'messaging', 'invitations', 'openapi', 'codebase', 'e2e'];
