...
$suites = ['logger', 'handlers', 'phone', 'jalali', 'validator', 'otp', 'user', 'charge', 'costissue', 'accounting', 'roles', 'documents', 'votes', 'notifications', 'payment_reminders', 'bulkusers', 'audit', 'security', 'reports', 'messaging', 'invitations', 'dashboard', 'openapi', 'codebase', 'e2e'];
