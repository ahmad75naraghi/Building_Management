<?php
/**
 * بخش‌های «پروفایل ساختمان» — شامل ساختار مجتمع، نمای گرافیکی واحدها،
 * سرویس‌ها/ماژول‌ها و اطلاعات اجمالی.
 *
 * این فایل بخشی از صفحهٔ یکپارچهٔ ساختمان (داشبورد) است؛ صفحهٔ جداگانه‌ای
 * به نام پروفایل ساختمان دیگر وجود ندارد.
 *
 * ورودی‌های لازم:
...
$financial = $bv_financial ?? [];
if (!isset($bv_financial)) {
...
if (isset($tickets_response['success']) && $tickets_response['success'] === true) {
    foreach ($tickets_response['data'] ?? [] as $t) {
...
?>
        ...
        <section class="quick-access-section">
            <div class="section-header-row">
                ...
                <a href="members.php?building_id=<?= (int) $building_id ?>" class="widget-view-all-link"><?= fa_digits(count($members)) ?> عضو</a>
            </div>
            <div class="tile-grid">
                <a href="blocks.php?building_id=<?= (int) $building_id ?>" class="tile-card">
                ...
                <a href="floors.php?building_id=<?= (int) $building_id ?>" class="tile-card">
                ...
                <a href="units.php?building_id=<?= (int) $building_id ?>" class="tile-card">
                ...
                <a href="common_areas.php?building_id=<?= (int) $building_id ?>" class="tile-card">
                ...
                <div class="bldg-card">
                    <div class="bldg-empty">
                        ...
                        <div class="bldg-empty-actions">
                            <a href="blocks.php?building_id=<?= (int) $building_id ?>" class="btn-chip btn-chip-edit">تعریف بلوک‌ها</a>
                            <a href="floors.php?building_id=<?= (int) $building_id ?>" class="btn-chip btn-chip-edit">تعریف طبقات</a>
                            <a href="units.php?building_id=<?= (int) $building_id ?>" class="btn-chip btn-chip-success">افزودن واحد</a>
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
        ...
        <section class="quick-access-section">
            <div class="section-header-row">
                ...
                <a href="reviews.php?building_id=<?= (int) $building_id ?>" class="widget-view-all-link">نظرات</a>
            </div>
            <div class="tile-grid">
                <a href="bookings.php?building_id=<?= (int) $building_id ?>" class="tile-card">
                ...
                <a href="votes.php?building_id=<?= (int) $building_id ?>" class="tile-card">
                    <div class="tile-icon" style="background: #f5f3ff; color: #8b5cf6;">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <path d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0 1 12 2.944a11.955 11.955 0 0 0-8.618 3.04A12.02 12.02 0 0 0 3 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                        </svg>
                    </div>
                    <span class="tile-label">رأی‌گیری</span>
                </a>
                <a href="visitors.php?building_id=<?= (int) $building_id ?>" class="tile-card">
                ...
                <a href="documents.php?building_id=<?= (int) $building_id ?>" class="tile-card">
                ...
                <a href="consumption.php?building_id=<?= (int) $building_id ?>" class="tile-card">
                ...
                <a href="emergency_contacts.php?building_id=<?= (int) $building_id ?>" class="tile-card">
                ...
                <a href="meetings.php?building_id=<?= (int) $building_id ?>" class="tile-card">
                    <div class="tile-icon" style="background: #eef2ff; color: #6366f1;">
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <path d="M17 20h5v-2a3 3 0 0 0-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 0 1 5.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 0 1 9.288 0M15 7a3 3 0 1 1-6 0 3 3 0 0 1 6 0z" />
                        </svg>
                ...
                <a href="reviews.php?building_id=<?= (int) $building_id ?>" class="tile-card">
        ...
        <section class="quick-access-section">
            ...
            <a href="members.php?building_id=<?= (int) $building_id ?>" class="info-row">
            ...
            <a href="units.php?building_id=<?= (int) $building_id ?>" class="info-row">
                <div class="info-row-right">
            ...
            <a href="costs.php?building_id=<?= (int) $building_id ?>" class="info-row">
                <div class="info-row-right">
            ...
            <a href="tickets.php?building_id=<?= (int) $building_id ?>" class="info-row">
                <div class="info-row-right">
